...
//$sql_chk = "SELECT application_confirm_status FROM mst_personal_details WHERE nic_no = '$enc_nic_no' ";
...
if($app_cnfm_status == "Y"){
    $display_msg = "We have received your application form. Thank you for using our online application submission system. You may download the PDF version of your submitted application by clicking below button.";
}else{
    $display_msg = "We encountered an error while checking your application status. Please try again";
}
?>
<!DOCTYPE html>
<html lang="en">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="card  border-1 rounded-lg mt-2">
                                                        ...
                                                        ?>
                                                            ...
                                                            <h4 class="alert-heading">Application received successfully !</h4>
                                                            ...
                                                            <a href="application_formpdf.php?idn=<?php echo $enc_nic_no; ?>"><input type="button" class="btn btn-primary btn-block" value="Download PDF version of my submitted application" /></a>
                                                        <?php
                                                        }else{
                                                        ?>
